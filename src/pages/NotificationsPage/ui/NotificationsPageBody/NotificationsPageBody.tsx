...
export const NotificationsPageBody = memo(
  (props: NotificationsPageBodyProps) => {
    ...
    return (
      <DynamicModuleLoader reducers={initialReducer} height>
        ...
        {isApprovalAssignment && currentTask && (
          <ApproveModal task={currentTask} onCloseClick={handleClose} />
        )}
