...
import cls from './NotificationsPageHeader.module.scss';

interface IncomingTaskPageHeaderProps {
  className?: string;
}

export const NotificationsPageHeader = memo(
  (props: IncomingTaskPageHeaderProps) => {
    ...
    const title = `${t('notifications')} (${isLoading ? '-' : tasksTotal})`;
